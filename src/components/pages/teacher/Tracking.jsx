        ...
        <div className="flex flex-col bg-white font-montserrat p-4 rounded-lg w-[1100px] max-h-4/5 overflow-y-auto">
            ...
            {/* <div className="flex flex-col gap-1 mb-4">
                ...
                <input
                    ...
                    placeholder=""
                    className={`border-2 p-2 w-1/3 border-gray-300 rounded-lg`} />
            </div>
            ...
            <div className="flex flex-col gap-1 mb-4">
                ...
                <textarea
                    ...
                    className={`border-2 p-2 w-1/3 border-gray-300  rounded-lg resize-none`}
                    rows="3"
                ></textarea>
            </div> */}
                ...
                <div className="flex flex-col p-1 gap-y-3">
                    {students.map((student) => (
                        <div className="grid grid-cols-5  ml-3">
                            ...
                            <div className="ml-20"><input className="border-2 rounded-md w-14 px-1 h-9 border-gray-300" type="number" /></div>
