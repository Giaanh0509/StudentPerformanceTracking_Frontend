...
export const SubjectDetailTeacher = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                const response = await axios.get(`https://studentperformancetrackingbackend-production.up.railway.app/subjects/${id}/skills`);
    ...
    return (
        <div className='flex flex-col h-full bg-white border-round mx-6 mt-4 p-3 shadow-lg rounded-lg'>
            <div className="flex">
