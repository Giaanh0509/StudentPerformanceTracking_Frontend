            ...
            <div className="col-span-3 flex flex-col justify-start items-center font-montserrat gap-y-4">
                ...
                <div className="flex flex-col gap-y-5 w-3/5">
                    <div className="flex items-center gap-x-2 bg-[#F4F8F5] px-2 py-1">
                        ...
                        <input type="text" className="p-2 bg-[#F4F8F5] focus:outline-none" placeholder="Username"/>
                    </div>

                    <div className="flex items-center gap-x-2 bg-[#F4F8F5] px-2 py-1">
                        <  RiLockPasswordLine  className="size-6 ml-2" />
                        <input type="text" className="p-2 bg-[#F4F8F5] focus:outline-none" placeholder="Password"/>
                    </div>

                    <div className="flex items-center gap-x-2 bg-[#F4F8F5] px-2 py-1">
                        <MdOutlineEmail className="size-6 ml-2"/>
                        <input type="text" className="p-2 bg-[#F4F8F5] focus:outline-none" placeholder="Email"/>
                    </div>

                    <div className="flex items-center gap-x-2 bg-[#F4F8F5] px-2 py-1">
                        <MdLocalPhone className="size-6 ml-2"/>
                        <input type="text" className="p-2 bg-[#F4F8F5] focus:outline-none" placeholder="PhoneNumber"/>
                    </div>
                </div>
