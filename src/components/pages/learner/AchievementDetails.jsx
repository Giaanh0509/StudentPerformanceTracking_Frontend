...
export const AchievementDetails = () => {
    ...
    useEffect(() => {
        {
            axios.get(`https://studentperformancetrackingbackend-production.up.railway.app/trackings/objectiveId=${id}`)
        ...
        if (student.id && trackings.length > 0) {
            const fetchAllTrackingDetails = async () => {
                ...
                for (const tracking of trackings) {
                    try {
                        const response = await axios.get(`https://studentperformancetrackingbackend-production.up.railway.app/trackings/objectiveId=${id}/trackingId=${tracking.id}/studentId=${student.id}`);
    ...
    useEffect(() => {
        const fetchData = async () => {
            axios.get(`https://studentperformancetrackingbackend-production.up.railway.app/objectives/objectiveId=${id}`)
                .then(response => {
                    {
